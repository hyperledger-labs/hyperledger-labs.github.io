...
We have an existing repository. We plan to copy code from that repository to the new Hyperledger Splice repository in the first few weeks after the project has been approved, instead of transferring the repository itself. 
